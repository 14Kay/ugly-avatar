...
function calculateBezierPoint(t: number, controlPoints: { x: number, y: number }[]) {
  let x = 0, y = 0;
...
function computeBezierCurve(controlPoints: { x: number, y: number }[], numberOfPoints: number) {
  let curve: number[][] = [];
...
export function generateHairLines0(faceCountour: number[][], numHairLines = 100) {
...
export function generateHairLines1(faceCountour: number[][], numHairLines = 100) {
  var faceCountourCopy = faceCountour.slice(0, faceCountour.length - 2);
  var results: number[][][] = [];
  for (var i = 0; i < numHairLines; i++) {
    var numHairPoints = 20 + Math.floor(randomFromInterval(-5, 5));
...
export function generateHairLines2(faceCountour: number[][], numHairLines = 100) {
...
export function generateHairLines3(faceCountour: number[][], numHairLines = 100) {
  var faceCountourCopy = faceCountour.slice(0, faceCountour.length - 2);
  var results: number[][][] = [];
  var pickedIndices: number[] = [];
  for (var i = 0; i < numHairLines; i++) {
